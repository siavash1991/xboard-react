...
import XTableResponsive from '@organisms/Tables/TableResponsive';
...
describe('XTableResponsive', () => {
	...
	it('renders correctly with provided className and mock table data', () => {
		...
		expect(
			screen.getByRole('heading', { name: /Responsive Table/i })
		).toBeInTheDocument();
	...
	it('displays the correct user avatars from mockTableData', () => {
		render(<XTableResponsive tableData={mockTableData} />);
