	...
	return (
		<div className={`search mr-5 rtl:mr-0 rtl:ml-5 ${className}`}>
			<div className="relative">
				<input
					type="text"
					className="bg-inherit dark:bg-gray-600 placeholder-gray-400 text-gray-500 text-sm border-none ring-4 ring-gray-200 dark:border-gray-700 h-8 w-full p-2 pl-3 pr-10 rtl:pr-3 rtl:pl-10 rounded-md focus:outline-none focus:ring-4 focus:ring-white focus:border-neutral-200 hover:cursor-pointer"
					placeholder="Search"
				/>
