...
const XBaseLayout: React.FC<BaseLayoutProps> = ({ children }) => {
	...
	return (
		<div className="grid grid-cols-12 bg-gradient-to-b from-pale-azure to-pale-ivory dark:from-gray-900 dark:to-gray-700">
			<aside className="col-span-4 sm:col-span-3 md:col-span-3 lg:col-span-2 h-screen sticky top-0 max-w-xs min-w-fit">
				<XSidebar />
			</aside>
			<main className="col-span-8  sm:col-span-9 md:col-span-9  lg:col-span-10 page-content p-6">
				<XHeader />
